...
class LaserBG:
    ...
    def photon_density(self, sphmap_params, preserve_integral=False, k=None):
        """
        ...
        dphoton_spherical = field_to_spherical(dphoton, preserve_integral=preserve_integral, k=k,
                                               **sphmap_params)
